package com.example.app_nosql.DB
...
import com.example.app_nosql.MODEL.CourseModel
...
class DBHandler
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        val query = ("CREATE TABLE" + TABLE_NAME + " ("
                + ID_COL + "INTEGER PRIMARY KEY AUTOICREMENT, "
                + NAME_COL + "TEXT,"
                + DURANTION_COL + "TEXT,"
    ...
    fun addNewCourse(
        ...
        values.put(DURANTION_COL, courseDuration)
    ...
    companion object {
        ...
        private const val DURANTION_COL = "duration"
